...
build-cluster-templates: $(RELEASE_DIR) cluster-templates
	...
	cp $(BYOH_TEMPLATES)/v1beta1/templates/docker/cluster-template-topology.yaml $(RELEASE_DIR)/cluster-template-topology.yaml
	cp $(BYOH_TEMPLATES)/v1beta1/templates/docker/clusterclass-quickstart.yaml $(RELEASE_DIR)/clusterclass-quickstart.yaml
